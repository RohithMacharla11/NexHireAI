...
export default function AssessmentsPage() {
    ...
    return (
        <div className="p-8">
            <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }}>
                <div className="flex justify-between items-center mb-8">
                    ...
                    <div className="flex gap-2">
                         <Button variant="outline"><BrainCircuit className="mr-2 h-4 w-4" /> AI Optimize All</Button>
                         <Button variant="outline"><FileJson className="mr-2 h-4 w-4" /> Import from JSON</Button>
                         <Button><PlusCircle className="mr-2 h-4 w-4" /> Create New Assessment</Button>
                    </div>
                </div>
            </motion.div>
            ...
            >
                <motion.div variants={itemVariants}><StatCard icon={<NotebookPen />} title="Total Assessments" value={stats.total} /></motion.div>
                <motion.div variants={itemVariants}><StatCard icon={<CheckCircle />} title="Active Assessments" value={stats.active} /></motion.div>
                <motion.div variants={itemVariants}><StatCard icon={<Clock />} title="Avg. Completion Time" value={`${stats.avgTime} min`} /></motion.div>
                    ...
                    {isLoading ? (
                        <div className="flex items-center justify-center text-center text-muted-foreground h-64">
                         ...
                         <div className="flex flex-col items-center justify-center text-center text-muted-foreground h-64">
                            ...
                            <p className="mb-4">No assessments found. Create your first one to get started.</p>
                            <Button><PlusCircle className="mr-2 h-4 w-4" /> Create New Assessment</Button>
                        </div>
                    ) : (
                        <motion.div
